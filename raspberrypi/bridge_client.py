...
#
# Vendored verbatim from arduino.app_utils.bridge (python-apps-base 0.11.0),
# with one change: the internal .logger dependency swapped for stdlib logging so
# the standalone field node (outside the App container) can use it. See
# bridge_radio.py for how the Sankat LoRa modem is reached over this client.
...
logger = logging.getLogger("sankat.bridge")
