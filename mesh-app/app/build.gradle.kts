...
dependencies {
    ...
    // JVM unit tests for pure logic (offline-tile zoom clamping, geo bearing/distance
    // formatting). JUnit 4, Eclipse Public License 1.0 — a standard test-only dependency.
