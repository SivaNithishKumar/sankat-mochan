...
daily build into a local PMTiles archive (offline demo tiles for app-simulator/).

The command post itself runs on the Bengaluru extract; the app-simulator/ demo stays set in
...
# DANGER_SPOT (11.6995/76.0605) in app-simulator/src/sim/lora.js with comfortable margin.
