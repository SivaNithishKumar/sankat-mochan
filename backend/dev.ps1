...
# fails with a connection error. Endpoints + model ids come straight from backend\.env
...
function Ensure-GenieX {
    ...
    Write-Host "  WARN: GenieX ($Label) did not answer within 30s; see backend\logs\geniex.$Label.err.log" -ForegroundColor Yellow
}
