...
Outputs (all consumed by the app / its parity test):
  mobile-application/app/src/main/assets/stt/mel_window512.f32   # 512-pt centered analysis window
  mobile-application/app/src/main/assets/stt/mel_fb.f32          # 257x80 mel filterbank, row-major
  mobile-application/app/src/androidTest/assets/mel_golden/pcm.f32     # input PCM (float32)
  mobile-application/app/src/androidTest/assets/mel_golden/mel.f32     # golden (80,T) mel, row-major
  mobile-application/app/src/androidTest/assets/mel_golden/meta.txt    # T + max-diff we achieved here
"""
